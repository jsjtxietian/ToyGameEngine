...
#include "QAQ/Core/Log.h"
	...
	#define QAQ_INTERNAL_ASSERT_NO_MSG(type, check) QAQ_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", QAQ_STRINGIFY_MACRO(check), ::Hazel::Assert::CurrentFileName(__FILE__), __LINE__)
