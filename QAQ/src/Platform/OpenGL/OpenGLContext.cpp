...
namespace QAQ {
	...
	void OpenGLContext::Init()
	{
		...
		QAQ_CORE_ASSERT(status, "Failed to initialize Glad!");
		...
		QAQ_CORE_ASSERT(GLVersion.major > 4 || (GLVersion.major == 4 && GLVersion.minor >= 5), "QAQ requires at least OpenGL version 4.5!");
	}
